/*
 * 这是ext3.4版本的官方例子，下载地址：http://cdn.sencha.com/ext/gpl/ext-3.4.1.1-gpl.zip
 */
require('./components/StartMenu');
require('./components/TaskBar');
require('./components/Desktop');
require('./components/App');
require('./components/Module');
require('./static/css/desktop.css');
/*
